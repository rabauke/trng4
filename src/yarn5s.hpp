...
namespace trng {
  ...
  public:
    ...
    explicit yarn5s(gen &g, parameter_type P=trng1) : P(P), S() {
...
//   inline bool yarn5s::boolean() const {
//     return operator()()<=modulus/2;
//   }

//   inline bool yarn5s::boolean(double p) const {
//     return operator()()<modulus*p;
//   }

//   inline double yarn5s::uniformco() const {
//     return static_cast<double>(operator()())/static_cast<double>(modulus);
//   }

//   inline double yarn5s::uniformco(double a, double b) const {
//     return uniformco()*(b-a)+a;
//   }

//   inline double yarn5s::uniformoc() const {
//     return (static_cast<double>(operator()())+1.0)/static_cast<double>(modulus);
//   }

//   inline double yarn5s::uniformoc(double a, double b) const {
//     return uniformoc()*(b-a)+a;
//   }

//   inline double yarn5s::uniformoo() const {
//     return (static_cast<double>(operator()())+1.0)/(static_cast<double>(modulus)+1.0);
//   }

//   inline double yarn5s::uniformoo(double a, double b) const {
//     return uniformoo()*(b-a)+a;
//   }

//   inline double yarn5s::uniformcc() const {
//     return static_cast<double>(operator()())/(static_cast<double>(modulus)-1.0);
//   }

//   inline double yarn5s::uniformcc(double a, double b) const {
