...
namespace trng {
  ...
  public:
    ...
    explicit mrg3s(gen &g, parameter_type P=trng1) : P(P), S() {
      seed(g);
    }
...
//     double uniformcc(double, double) const;
  ...
  inline mrg3s::result_type mrg3s::operator()() const {
    step();
    return S.r1;
  }
  
  inline long mrg3s::operator()(long x) const {
    return static_cast<long>(utility::uniformco(*this)*x);
  }

//   inline bool mrg3s::boolean() const {
//     step();
//     return S.r1<=modulus/2;
//   }

//   inline bool mrg3s::boolean(double p) const {
//     step();
//     return S.r1<modulus*p;
//   }
  
//   inline double mrg3s::uniformco() const {
//     step();
//     return static_cast<double>(S.r1)/static_cast<double>(modulus);
//   }

//   inline double mrg3s::uniformco(double a, double b) const {
//     return uniformco()*(b-a)+a;
//   }
  
//   inline double mrg3s::uniformoc() const {
//     step();
//     return (static_cast<double>(S.r1)+1.0)/static_cast<double>(modulus);
//   }

//   inline double mrg3s::uniformoc(double a, double b) const {
//     return uniformoc()*(b-a)+a;
//   }
  
//   inline double mrg3s::uniformoo() const {
//     step();
//     return (static_cast<double>(S.r1)+1.0)/(static_cast<double>(modulus)+1.0);
//   }

//   inline double mrg3s::uniformoo(double a, double b) const {
//     return uniformoo()*(b-a)+a;
//   }

//   inline double mrg3s::uniformcc() const {
//     step();
//     return static_cast<double>(S.r1)/(static_cast<double>(modulus)-1.0);
//   }

//   inline double mrg3s::uniformcc(double a, double b) const {
