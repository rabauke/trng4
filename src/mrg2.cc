...
namespace trng {
  ...
  const mrg2::result_type mrg2::modulus=2147483647l;
  const mrg2::result_type mrg2::min=0l;
  const mrg2::result_type mrg2::max=2147483646l;
  ...
  bool operator==(const mrg2::parameter_type &P1,
    ...
    return P1.a1==P2.a1 && P1.a2==P2.a2;
  }
