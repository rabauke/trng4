...
namespace trng {
  ...
  const mrg3s::result_type mrg3s::modulus=2147462579l;  // 2^31-21069
  const mrg3s::result_type mrg3s::min=0l;
  const mrg3s::result_type mrg3s::max=2147462578l;
  ...
  bool operator==(const mrg3s::parameter_type &P1,
    ...
    return P1.a1==P2.a1 && P1.a2==P2.a2 && P1.a3==P2.a3;
  }
  ...
  void mrg3s::split(unsigned int s, unsigned int n) {
    if (s<1 || n>=s)
      throw std::invalid_argument("invalid argument for trng::mrg3s::split");
  ...
  void mrg3s::jump2(unsigned int s) {
  ...
  void mrg3s::jump(unsigned long long s) {
    unsigned int i(0);
    while (s>0) {
      if (s%2==1)
	jump2(i);
