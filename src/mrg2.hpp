...
//   inline bool mrg2::boolean() const {
//     step();
//     return S.r1<=modulus/2;
//   }

//   inline bool mrg2::boolean(double p) const {
//     step();
//     return S.r1<modulus*p;
//   }
  
//   inline double mrg2::uniformco() const {
//     step();
//     return static_cast<double>(S.r1)/static_cast<double>(modulus);
//   }

//   inline double mrg2::uniformco(double a, double b) const {
//     return uniformco()*(b-a)+a;
//   }
  
//   inline double mrg2::uniformoc() const {
//     step();
//     return (static_cast<double>(S.r1)+1.0)/static_cast<double>(modulus);
//   }

//   inline double mrg2::uniformoc(double a, double b) const {
//     return uniformoc()*(b-a)+a;
//   }
  
//   inline double mrg2::uniformoo() const {
//     step();
//     return (static_cast<double>(S.r1)+1.0)/(static_cast<double>(modulus)+1.0);
//   }

//   inline double mrg2::uniformoo(double a, double b) const {
//     return uniformoo()*(b-a)+a;
//   }

//   inline double mrg2::uniformcc() const {
//     step();
//     return static_cast<double>(S.r1)/(static_cast<double>(modulus)-1.0);
//   }
  
//   inline double mrg2::uniformcc(double a, double b) const {
