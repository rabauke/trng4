...
namespace trng {
  ...
  const mrg4::result_type mrg4::modulus=2147483647l;
  const mrg4::result_type mrg4::min=0l;
  const mrg4::result_type mrg4::max=2147483646l;
  ...
  bool operator==(const mrg4::parameter_type &P1,
    ...
    return P1.a1==P2.a1 && P1.a2==P2.a2 && P1.a3==P2.a3 && P1.a4==P2.a4;
  }
