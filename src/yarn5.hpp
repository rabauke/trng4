...
//   inline bool yarn5::boolean() const {
//     return operator()()<=modulus/2;
//   }

//   inline bool yarn5::boolean(double p) const {
//     return operator()()<modulus*p;
//   }

//   inline double yarn5::uniformco() const {
//     return static_cast<double>(operator()())/static_cast<double>(modulus);
//   }

//   inline double yarn5::uniformco(double a, double b) const {
//     return uniformco()*(b-a)+a;
//   }

//   inline double yarn5::uniformoc() const {
//     return (static_cast<double>(operator()())+1.0)/static_cast<double>(modulus);
//   }

//   inline double yarn5::uniformoc(double a, double b) const {
//     return uniformoc()*(b-a)+a;
//   }

//   inline double yarn5::uniformoo() const {
//     return (static_cast<double>(operator()())+1.0)/(static_cast<double>(modulus)+1.0);
//   }

//   inline double yarn5::uniformoo(double a, double b) const {
//     return uniformoo()*(b-a)+a;
//   }

//   inline double yarn5::uniformcc() const {
//     return static_cast<double>(operator()())/(static_cast<double>(modulus)-1.0);
//   }

//   inline double yarn5::uniformcc(double a, double b) const {
